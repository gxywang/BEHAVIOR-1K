#!/bin/bash
# TiPToP planning server (ws://host:8765). Needs M2T2 running (start_m2t2.sh).
...
#      TIPTOP_MAX_PLANNING_TIME, TIPTOP_GPU (index or UUID; pins CUDA_VISIBLE_DEVICES on shared multi-GPU boxes).
...
# See ../DEPLOYMENT.md and ../README.md "Rerun".
set -e

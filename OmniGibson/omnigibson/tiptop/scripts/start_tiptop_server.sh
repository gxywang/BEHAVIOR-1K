...
# Env: TIPTOP_DIR (default: this repo's tiptop/ submodule), TIPTOP_HOST/TIPTOP_PORT, TIPTOP_PARTICLES,
...
exec pixi run tiptop-server --config tiptop/config/tiptop_sim_panda.yml \
